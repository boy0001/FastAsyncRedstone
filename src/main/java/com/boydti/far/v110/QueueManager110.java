...
public class QueueManager110 extends QueueManager {
    private net.minecraft.server.v1_10_R1.Chunk cachedChunk;
    ...
    public final IBlockData getTypeFast(net.minecraft.server.v1_10_R1.World world, BlockPosition pos) {
        return getTypeFast(world, pos.getX(), pos.getY(), pos.getZ());
    }

    public final IBlockData getTypeFast(net.minecraft.server.v1_10_R1.World world, int x, int y, int z) {
        int x4 = x >> 4;
        int z4 = z >> 4;
        ...
        if (cachedSection == net.minecraft.server.v1_10_R1.Chunk.a) {
            return air;
        }
    ...
    public void updateBlockFast(World world, BlockPosition pos, IBlockData state, Block block, boolean light, int physics) {
        ...
        int z = pos.getZ();
        int y = pos.getY();
        net.minecraft.server.v1_10_R1.Chunk chunk = world.getChunkAtWorldCoords(pos);
